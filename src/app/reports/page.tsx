...
import { Loader2, Download, TrendingUp, Users, CreditCard, Activity } from 'lucide-react';
        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    ...
                    <p className="text-slate-400 mt-1">Real-time insights into your fund performance</p>
                </div>
                <button
                    onClick={exportCSV}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="glass-card p-6 border-l-4 border-indigo-500">
                    <div className="flex justify-between items-start">
                        <div>
                            <p className="text-slate-400 text-sm font-medium uppercase tracking-wider">Total Collection</p>
                ...
                <div className="glass-card p-6 border-l-4 border-emerald-500">
                    <div className="flex justify-between items-start">
                        <div>
                            <p className="text-slate-400 text-sm font-medium uppercase tracking-wider">Active Members</p>
                ...
                <div className="glass-card p-6 border-l-4 border-rose-500">
                    <div className="flex justify-between items-start">
                        <div>
                            <p className="text-slate-400 text-sm font-medium uppercase tracking-wider">Top Mode</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="glass-card p-6">
                    ...
                    <div className="h-60 w-full relative">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                            <span className="text-sm text-slate-500 font-medium">Modes</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="lg:col-span-2 glass-card p-6 overflow-hidden">
                    <div className="flex justify-between items-center mb-6">
                        ...
                        <span className="text-xs text-slate-500 bg-slate-800 px-2 py-1 rounded">Last 10</span>
                    </div>
                                    ...
                                    <tr key={tx._id} className="border-b border-white/5 hover:bg-white/5 transition-colors">
                                        ...
                                        <td className="p-3 text-center">
                                            <span className={`px-2 py-0.5 rounded text-xs font-bold uppercase ${tx.paymentMode === 'CASH' ? 'bg-emerald-500/10 text-emerald-400' :
                                                tx.paymentMode === 'UPI' ? 'bg-blue-500/10 text-blue-400' : 'bg-slate-700 text-slate-300'
                                                }`}>
                                                {tx.paymentMode}
                                            </span>
                                        </td>
